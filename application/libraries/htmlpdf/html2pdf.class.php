...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_margeLeft        = 8;           // current marges of the page
        protected $_margeTop         = 8;
        protected $_margeRight       = 8;
        protected $_margeBottom      = 8;
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(8, 8, 8, 8))
        {
